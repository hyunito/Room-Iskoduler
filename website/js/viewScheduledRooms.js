...
function renderBookings() {
    ...
    bookings.forEach((booking, idx) => {
        ...
        const endTime = booking.endTime
            ...
            : calculateEndTime(booking.startTime || booking.time, booking.durationMinutes || booking.duration) || '';
...
function openBookingModal(booking) {
    ...
    const endTime = booking.endTime ? formatTime(booking.endTime): calculateEndTime(booking.startTime || booking.time, booking.durationMinutes || booking.duration) || '';
